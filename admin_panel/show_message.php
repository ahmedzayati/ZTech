      ...
      <nav class="navbar navbar-expand-md bg-dark navbar-dark ">
         ...
         <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav">
                     ...
                     <form method="POST" action="getdata.php" enctype="multipart/form-data" style="padding: 20px;"" class="modal-content animate form-row">
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <input type="number"  id="price" aria-describedby="emailHelp" class="form-control" placeholder="price" name="price" required maxlength="30">
                           </div>
                        </div>
                        <div class="form-row">
                           <div class="form-group col-md-6">
               ...
               <li>
                  <button class="btn btn-primary"  style="height: 25px; margin-left: 6px;" ><a href="supression.php" style="position: relative;bottom: 7px;color: white">Supprimer produit</a></button>
               </li>
               <li>
                  ...
                  <table class="table table-striped">
                     ...
                     <tbody>
                        <?php  
                           ...
                           $query = "SELECT email,message,date FROM message order by date desc limit 6 ";
