...
<head>
  ...
  <link rel="stylesheet" href="cs7.css" />
...
<body style="background: url('back.jpg') no-repeat fixed; background-size: 100% 100%;">
          ...
          <ul class="navbar-nav">
            <li class="nav-item" style="margin-bottom: 3px;margin-right: 7px;" >
              ...
              <div id="id02" class="modal" >
                ...
                <form class="modal-content animate form-row" action="/action_page.php" style="padding: 20px;">
                ...
                <form class="modal-content animate" action="/action_page.php" style="padding: 20px;">
                    ...
                    <div class="clearfix">
                      ...
                      <button type="submit" class="signupbtn" style="height: 50px;width: 200px;">Sign Up</button>
                        ...
                        <li class="nav-item" style="margin-bottom: 3px;margin-right: 7px;">
              <button onclick="document.getElementById('id03').style.display='block'" class="btn btn-primary" id="sign" style="height: 25px;" ><p style="position: relative;bottom: 7px;">Inserer produit</p></button>
 ...
 <input type="submit" name="submit_image" value="Upload"  class="btn btn-primary">
            ...
            <li>
              <button class="btn btn-primary"  style="height: 25px;" ><p style="position: relative;bottom: 7px;">Messages reçus</p></button>
  ...
  <div class="col-md-9  "  >
    ...
    <table class="table table-striped">
      ...
      <?php  
          ...
          $query = "SELECT email,message,date FROM message order by quantite desc limit 6 ";
